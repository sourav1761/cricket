...
// import { load } from '@cashfreepayments/cashfree-js'; // Commented out Cashfree
...
function PlayerRegistrationContent() {
  ...
  // const cashfreeRef = useRef(null); // Commented out Cashfree

  // Initialize Cashfree - COMMENTED OUT
  // useEffect(() => {
